...
checkbox_mostrar_tabela = st.sidebar.checkbox('Mostra tabela')
...
categorias2 = list(dados['Categoria'].unique())

categoria_grafico = st.sidebar.selectbox('Selecione a categoria para apresentar a tabela', options = categorias2)
